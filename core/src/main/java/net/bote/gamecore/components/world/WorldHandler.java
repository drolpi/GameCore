package net.bote.gamecore.components.world;
...
import net.bote.gamecore.components.world.map.AbstractDefinition;
import net.bote.gamecore.components.world.map.DefinitionTypeAdapter;
import net.bote.gamecore.components.world.map.GameMap;
import net.bote.gamecore.components.world.map.MapInfo;
import net.bote.gamecore.components.world.map.storage.JsonMapInfoStorage;
import net.bote.gamecore.components.world.map.storage.MapInfoStorage;
